        ...
        <div class="container custom-margin-top">
            <div class="row mb-5">
                                    ...
                                    <a href="{{route('servicedetail',$item->slug)}}" title="{{ $item->title}}" class="text-decoration-none">
                                        <div class="card custom-card-style-1 border-radius-0">
                                            <div class="card-body text-center p-5 mb-4">
                                                <img width="75" height="75" src="/frontend/architecture-2/icons/house-plant.svg" alt="{{ config('settings.siteTitle')}}" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mt-3 mb-4 pb-3'}" />
                ...
                <div id="start" class="row align-items-center pb-xl-5 mb-xl-5">
                    <div class="col-12 col-lg-4 col-xl-5 pb-5 pb-lg-0 mb-5 mb-lg-0">
                        <div class="position-relative">
                            <img src="/frontend/architecture-2/backgrounds/arch-plan-2.jpg" class="img-fluid position-absolute left-0 z-index-0 appear-animation" alt="{{ config('settings.siteTitle')}}" data-appear-animation="fadeIn" data-appear-animation-delay="850" style="bottom: -168px;" />
                            <div class="overflow-hidden position-relative z-index-1">
                                <img src="/frontend/hakkimizda-3.jpg" class="img-fluid appear-animation" alt="{{ config('settings.siteTitle')}}" data-appear-animation="maskLeft" data-appear-animation-delay="250" />
                            </div>
                            <div class="overflow-hidden position-absolute z-index-2" style="bottom: -75px; right: -17%;">
                                <img src="/frontend/hakkimizda-2.jpg" style="width:300px" class="img-fluid appear-animation" alt="{{ config('settings.siteTitle')}}" data-appear-animation="maskRight" data-appear-animation-delay="550" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7 col-xl-5 offset-lg-1 position-relative pt-5 pt-lg-0">
                        ...
                        <div class="pt-lg-5 ps-lg-5 mt-lg-5">
                            ...
                            <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
                                <img src="/frontend/architecture-2/divider.jpg" class="img-fluid opacity-5 mb-4" alt="{{ config('settings.siteTitle')}}" />
                            </div>
    ...
    <section class="section section-height-3 border-0 m-0">
        <div class="container py-2">
            <div class="row counters counters-sm">
                <div class="col-sm-6 col-lg-3 col-6 mb-5 mb-lg-0">
                    <div class="counter">
                        <strong class="text-color-dark font-weight-bold line-height-1 text-8  mb-2" data-to="25" data-append="+">0</strong>
                ...
                <div class="col-sm-6 col-lg-3 col-6 mb-5 mb-lg-0">
                    <div class="counter">
                        <strong class="text-color-dark font-weight-bold line-height-1 text-8  mb-2" data-to="350" data-append="+">0</strong>
                        <label class="text-color-default positive-ls-3 font-weight-normal text-3-5 mb-0">MÜŞTERİ</label>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 col-6 mb-5 mb-sm-0">
                    <div class="counter">
                        <strong class="text-color-dark font-weight-bold line-height-1 text-8  mb-2" data-to="10" data-append="+">0</strong>
                ...
                <div class="col-sm-6 col-lg-3 col-6 mb-5 mb-sm-0">
                    <div class="counter">
                        <strong class="text-color-dark font-weight-bold line-height-1 text-8 mb-2" data-to="950" data-append="+">0</strong>
    ...
    <div class="container container-xl-custom py-4 my-3">
        ...
        <div class="masonry-loader masonry-loader-loaded">
            <div class="masonry row" data-plugin-masonry="" data-plugin-options="{'layoutMode': 'packery', 'itemSelector': '.masonry-item', 'sortBy': 'original-order'}" style="position: relative;">
                @foreach ($Project->take(20) as $item)
